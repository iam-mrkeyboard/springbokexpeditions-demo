...
export const CATEGORY_TOURS: Record<TourCategory, string[]> = {
  luxury: [
    '7-day-luxury-serengeti-and-ngorongoro-fly-in-safari',
    'bespoke-luxury-safari-designed-around-you',
    '9-day-off-the-beaten-path-western-serengeti-and-grumeti-safari',
    '8-day-tanzania-photography-safari',
    '10-day-tanzania-northern-circuit-classic',
    '7-day-signature-northern-circuit-safari',
    '8-day-mara-river-crossing-safari',
  ],
  'mid-range': [
    '10-day-tanzania-northern-circuit-classic',
    '7-day-signature-northern-circuit-safari',
    '7-day-great-migration-calving-safari',
    '7-day-tanzania-birding-safari',
    '7-day-cultural-tanzania-maasai-hadzabe-local-life',
    '8-day-mara-river-crossing-safari',
    '6-day-family-safari-adventure',
    '6-day-walking-and-bush-safari',
    '5-day-cultural-walking-and-village-immersion',
    '5-day-tarangire-and-ngorongoro-mid-range-safari',
    '4-day-big-five-express-safari',
    '3-day-tarangire-and-lake-manyara-safari',
  ],
  budget: [
    '6-day-budget-northern-tanzania-camping-safari',
    '5-day-budget-tarangire-serengeti-ngorongoro',
    '7-day-signature-northern-circuit-safari',
    '4-day-zanzibar-island-hopping-budget-escape',
    '4-day-big-five-express-safari',
    '3-day-tarangire-and-lake-manyara-safari',
  ],
  honeymoon: [
    '7-day-zanzibar-honeymoon-beach-escape',
    '7-day-northern-tanzania-honeymoon-safari',
    '6-day-honeymoon-safari-and-beach',
    '5-day-romantic-serengeti-and-ngorongoro-honeymoon',
    '4-day-romantic-escape-serengeti',
  ],
  family: [
    '6-day-family-safari-adventure',
    '5-day-tarangire-and-ngorongoro-mid-range-safari',
  ...
  birding: [
    '7-day-tanzania-birding-safari',
    '6-day-walking-and-bush-safari',
    '7-day-remote-ruaha-and-nyerere-selous-safari',
  ],
  cultural: [
    '7-day-cultural-tanzania-maasai-hadzabe-local-life',
    '5-day-cultural-walking-and-village-immersion',
